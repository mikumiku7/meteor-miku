...
//        .name("忽略自己")
//        .description("在第三人称或自由视角时不显示自己的名称标签。")
//        .defaultValue(true)
//        .build()
//    );
//
...
//        .name("渲染裁剪")
//        .description("仅在指定数量或距离范围内渲染名称标签。")
//        .defaultValue(false)
//        .build()
//    );
//
...
//        .name("显示装备")
//        .description("在名称标签上方显示玩家的盔甲与手持物品。")
//        .defaultValue(true)
//        .build()
//    );
//
...
//        .name("显示耐久")
//        .description("以总数、百分比或不显示的方式显示物品耐久。")
...
//
//    public Nametags() {
//        super(BaseModule.CATEGORY_MIKU_PRO, "名称标签+", "在玩家、物品及其他实体上方显示可自定义的名称标签。");
//    }
//
//
...
//        entityList.clear();
//        boolean freecamNotActive = true;
//        try {
//            freecamNotActive = !Modules.get().isActive(Freecam.class);
//        } catch (Exception e) {
//        }
//
//
